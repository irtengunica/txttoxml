...
dx=0
with open("testtf.json") as json_file:  
 ...
 for jsn in data['frameler']:
  ...
  if frame_idlist[dx]==jsn['frame_id']:
   ...
   image=cv2.putText(image,secilendosyalist[jsn['frame_id']-1]+'_'+str(jsn['frame_id']),(10,500),cv2.FONT_HERSHEY_SIMPLEX,2,(255,255,255),8,cv2.LINE_AA)
